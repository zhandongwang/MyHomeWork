...
@interface WZDWebViewController ()<JSObjcDelegate, UIWebViewDelegate, WKScriptMessageHandler, WKNavigationDelegate,WKUIDelegate>
...
@implementation WZDWebViewController
