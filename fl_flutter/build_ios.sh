...
# git repository path
PRODUCT_GIT_DIR="/Users/wangzhandong/Documents/Development/CCDPods/FL_flutter"
...
flutter_get_packages() {
    ...
    # else 
    #     # bash -c "$(curl -fsSL https://github.com/passsy/flutter_wrapper/blob/master/install.sh)"
    #     sh -c "$(curl -fsSL http://raw.githubusercontent.com/passsy/flutter_wrapper/master/install.sh)"
    #     # bash "/Users/wangzhandong/Documents/Development/flutter_wrapper/install.sh"
    #     if [[ $? -ne 0 ]]; then
