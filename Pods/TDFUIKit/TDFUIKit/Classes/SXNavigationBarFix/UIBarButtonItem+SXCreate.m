...
+(UIBarButtonItem *)itemWithTarget:(id)target action:(SEL)action title:(NSString *)title titleColor:(UIColor *)titleColor {
    return [self itemWithTarget:target action:action title:title font:[UIFont systemFontOfSize:15] titleColor:titleColor highlightedColor:nil titleEdgeInsets:UIEdgeInsetsZero];
}
